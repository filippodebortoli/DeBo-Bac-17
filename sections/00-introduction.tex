...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
where \(\mathbb{N} \rightharpoonup \mathbb{N}\) is the set of partial functions from \(\mathbb{N}\) to \(\mathbb{N}\); thus is --- thanks to Kleene's fixed point theorem --- the function \(f\) is
\begin{align*}
